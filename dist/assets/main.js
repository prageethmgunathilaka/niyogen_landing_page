...
class ContactModalAnimation {
  ...
  bindEvents() {
    var _a, _b, _c, _d;
    (_a = this.modalTrigger) == null ? void 0 : _a.addEventListener("click", () => this.openModal());
    (_b = this.modalCloseBtn) == null ? void 0 : _b.addEventListener("click", () => this.closeModal());
    (_c = this.modalCloseBtnSecondary) == null ? void 0 : _c.addEventListener("click", () => this.closeModal());
    (_d = this.modalOverlay) == null ? void 0 : _d.addEventListener("click", (e) => {
...
class FooterContactModal {
  ...
  openModal() {
    ...
    if (typeof gsap !== "undefined") {
      ...
      tl.set(this.overlay, { display: "grid" }).to(this.overlay, {
        opacity: 1,
        duration: 0.3,
        ease: "power2.out"
      }).to(this.content, {
  ...
  closeModal() {
    ...
    if (typeof gsap !== "undefined") {
      ...
      tl.to(this.content, {
        ...
        duration: 0.2,
        ease: "power2.in"
      }, "-=0.1").set(this.overlay, { display: "none" });
    } else {
      this.overlay.style.display = "none";
      this.overlay.style.opacity = "0";
