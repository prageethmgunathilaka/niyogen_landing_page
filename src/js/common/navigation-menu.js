...
class NavigationMenu {
  ...
  bindEvents() {
    // Get all navigation items with dropdowns/mega menus
    ...
    document.addEventListener(
      ...
      (e) => {
        if (
          ...
          this.isMouseInMenu = false;
          // Only hide if not moving to header or another menu/bridge
          const relatedTarget = e.relatedTarget;
    ...
    // Additional safety: hide menus when mouse leaves the entire viewport
